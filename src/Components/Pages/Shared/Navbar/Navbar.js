        ...
        <div className="flex justify-end items-center  md:w-2/3">
          ...
          <div className="flex items-center ">
            ...
            {user.email ? (
              ...
              //
              <Link to="/login">
                <button className="inline-block px-5 py-4 text-white rounded-lg bg-gradient-to-br from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-700 lg:px-8 md:transform md:-translate-y-2">
                  Login
                </button>
              </Link>
            )}
