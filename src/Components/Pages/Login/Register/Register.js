        ...
        <div className="mt-6">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-5 my-4">
            ...
            <input
              type="submit"
              value="Register"
              className=" w-full inline-block px-5 py-4 text-white rounded-lg bg-gradient-to-br from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-700 lg:px-8 md:transform md:-translate-y-2"
            />
          </form>
