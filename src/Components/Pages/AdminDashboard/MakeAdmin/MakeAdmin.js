...
const MakeAdmin = () => {
  ...
  useEffect(() => {
    axios
      .get("https://frozen-crag-61975.herokuapp.com/users")
  ...
  const handleMakeAdmin = () => {
    ...
    if (filter.test(email)) {
      axios({
        ...
        url: `https://frozen-crag-61975.herokuapp.com/users/${email}`,
        data: "",
        headers: {
    ...
    <div>
      ...
      <div className="md:w-3/4 flex mt-5 ">
        ...
        <button
          ...
          className="inline-block px-5 py-4 text-white rounded-lg bg-gradient-to-br from-indigo-600 to-indigo-700 hover:from-indigo-500 hover:to-indigo-700 lg:px-8 w-56 ml-3 transition-all"
        >
          Make Admin
        </button>
      </div>
      ...
      <div className="mt-5 border-t-2 border-gray-400 pt-5">
        ...
        <div className="mt-4">
          <table className="table-auto w-full text-center">
            <thead>
              <tr className="bg-gradient-to-br from-indigo-600 to-indigo-700 text-white h-10">
                <th className="border-2 border-white">Name</th>
                <th className="border-2 border-white">Email</th>
                <th className="border-2 border-white">Role</th>
              </tr>
            </thead>
            <tbody>
              {users.map((user) => (
