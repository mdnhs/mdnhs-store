...
const ManageAllOrders = () => {
  ...
  useEffect(() => {
    axios
      .get("https://frozen-crag-61975.herokuapp.com/orders")
  ...
  const handleDeleteOrder = (id) => {
    ...
    // console.log(id);
    deleteConfirm &&
      axios.delete(`https://frozen-crag-61975.herokuapp.com/orders/${id}`).then((res) => {
      ...
      <div className="overflow-x-scroll md:overflow-x-hidden">
        <table className=" table-auto bg-white w-full shadow-md ">
          <thead className="h-10">
            <tr className="bg-gradient-to-br from-indigo-600 to-indigo-700 text-white border-2 border-white ">
